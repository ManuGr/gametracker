...
<div class="max-w-screen-xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-4">
    {#each $games as game}
        <button class="flex flex-col border rounded-lg shadow-sm md:flex-row md:max-w-xl border-gray-700 bg-white/10 hover:bg-white/20 hover:scale-105 transition-transform duration-200">
